        ...
        <div className="h-100% bg-gradient-to-b from bg-white via-blue-300 to-blue-700">
            ...
            <div className="content-wrapper">
                ...
                <section className="livePerformance-wrapper text-center">
                        <h1 className="text-3xl my-16 md:text-7xl text-center font-Montserrat font-bold text-pink-700 subpixel-antialiased filter drop-shadow-xl gray-200 select-none">
                            Live Performance
                        </h1>
                        <h1 className="text-2xl font-bold text-center text-red-700 drop-shadow-xl">This project is on halt due to lack of consistent resource and design. will be back in the future</h1>
